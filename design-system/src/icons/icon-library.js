// LYD Design System - Complete Icon Library
// All icons optimized for 24x24 viewBox, using currentColor for theming
...
export class LydIcon extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    if (!iconSvg) {
      console.warn(`Icon "${name}" not found in LYD_ICONS`);
      return;
    }
...
customElements.define('lyd-icon', LydIcon);
