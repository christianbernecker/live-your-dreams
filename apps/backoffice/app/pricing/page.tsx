    ...
    <div className="backoffice-layout">
      ...
      <main className="backoffice-main">
        <header className="backoffice-header">
          <h1 style={{ margin: '0', fontSize: 'var(--font-size-xl)', fontWeight: 'var(--font-weight-bold)' }}>Preisrechner</h1>
          <p style={{ margin: '8px 0 0 0', color: 'var(--lyd-grey)' }}>Kostenberechnung mit Design System UI</p>
        </header>
