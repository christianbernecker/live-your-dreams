    ...
    <div className="backoffice-layout">
      ...
      <main className="backoffice-main">
        <header className="backoffice-header">
          <h1 style={{ margin: '0', fontSize: 'var(--font-size-xl)', fontWeight: 'var(--font-weight-bold)' }}>Zwei-Faktor-Authentifizierung</h1>
          <p style={{ margin: '8px 0 0 0', color: 'var(--lyd-grey)' }}>2FA-Sicherheitseinstellungen</p>
        </header>
