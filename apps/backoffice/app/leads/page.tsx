    ...
    <div className="backoffice-layout">
      <aside className="backoffice-sidebar">
        ...
        <nav>
          ...
          <a href="/leads" className="backoffice-nav-item active">
      ...
      <main className="backoffice-main">
        <header className="backoffice-header">
          <h1 style={{ margin: '0', fontSize: 'var(--font-size-xl)', fontWeight: 'var(--font-weight-bold)' }}>Interessenten</h1>
          <p style={{ margin: '8px 0 0 0', color: 'var(--lyd-grey)' }}>Lead-Management mit Design System UI</p>
        </header>
        
        <div className="component-card">
          <h3>Lead-Übersicht</h3>
